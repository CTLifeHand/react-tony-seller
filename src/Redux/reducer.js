import Immutable from 'immutable' // Immutable Data 就是一旦创建，就不能再被更改的数据。
import { SET_STATE, REQUEST_POSTS, RECEIVE_POSTS } from './action'
import { RECORD_STATE, SAVE_PRODUCT_LIST, NEW_PRODUCT_DATA } from './action'
import { DELETE_ITEM } from './action'
import { GET_DATA_START, GET_DATA_SUCCESS, TEST_DISPATCH } from './action'
